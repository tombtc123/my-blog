...
screenshots:
  ...
  - '/apps/timecue/02-schedule-your-clearer-self.png'
  - '/apps/timecue/03-choose-the-signal.png'
  - '/apps/timecue/04-let-it-return-later.png'
  - '/apps/timecue/05-test-before-you-trust-it.png'
tags: ['Productivity', 'Reminder', 'Focus', 'Intention', 'Local Notifications']
keywords:
  - TimeCue
...
faq:
  - question: 'Does TimeCue collect data?'
    answer: 'No. TimeCue stores cue settings locally on your device and does not send them to the developer.'
...
<div class="tc-page">
<figure class="tc-og">
<img src="/apps/timecue/og.jpg" alt="TimeCue product preview with the app icon and an iPhone screenshot" />
</figure>
...
<section class="tc-gallery" aria-label="TimeCue App Store preview images">
<img src="/apps/timecue/02-schedule-your-clearer-self.png" alt="TimeCue custom reminder scheduling preview" />
<img src="/apps/timecue/03-choose-the-signal.png" alt="TimeCue notification style preview" />
<img src="/apps/timecue/05-test-before-you-trust-it.png" alt="TimeCue test notification preview" />
</section>

<section class="tc-privacy-band">
<div>
